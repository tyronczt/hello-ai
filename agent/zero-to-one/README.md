...
> 初版资料核验：2026-09-09；学习方法更新：2026-09-14；工程导读更新：2026-09-15。面向会 Java、了解基本 HTTP / JSON、没有 Agent 经验的开发者。整套内容独立使用，不依赖任何现有业务工程。

**主线：LLM 基础 → 工具调用 → Agent Loop → RAG 与记忆 → 评测 → MCP / Skills → 工程化。** 默认选择 Spring AI 做 Java 实践；偏好声明式接口的同学可以选择 LangChain4j，两条路线选一条即可。

学习时先用 [07 用 AI 学 Agent](07-learning-with-ai.md) 写下自己的基础、目标和限制；每次先作答，再看讲解。
...
| 7 | [用 AI 学 Agent：提问、类比与闭卷练习](07-learning-with-ai.md) | 学习起点卡、错误记录和迁移练习 |
| 8 | [李博杰著作与川处安文章：工程导读](08-agent-engineering-reading.md) | v1.0 页码导航、四个练习与版本边界 |

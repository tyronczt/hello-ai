...
[小山学堂：AI 教我学习](https://xueai.miyang.cn/slides/learn.html#learn-1.html) 的 learn-1、learn-3、learn-4、learn-5、learn-15 五个课节已读公开正文。重点是匹配学习起点、明确提问场景、逐题作答与闭卷核对；Java 练习及逐课安排见 [第 07 章](07-learning-with-ai.md)。页面未见明确发布日期，归为“查阅日期已确认、发布日期待确认”，不计入 2026 新课。其他资源的核验日期仍是上方初版日期，本次未全部重新核验。

## 2026-09-15 增补：原理与工程

- **X05**：[川处安：一篇速通入门：重新理解 AI Agent 的一切](https://x.com/leoshen0/status/2099641267726758095)。页面日期 2026-09-15，已在浏览器读取正文。用于概念串联；全量历史、MCP 加载和缓存收益等说法须区分具体实现。
- **G28 / 用户提供 PDF**：[李博杰 ai-agent-book](https://github.com/bojieli/ai-agent-book)。用户 PDF 封面 v1.0、2026-07-15、共 307 页；本次核读目录与相关正文选页。官方仓库 README 当前为 2.0，章节已调整；未运行配套实验。

先读哪里、怎样对应 Java 练习、哪些说法不能直接照搬，见 [第 08 章联合导读](08-agent-engineering-reading.md)。旧资源没有因此变为本次重新核验。
